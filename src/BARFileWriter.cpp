...
bool CBARFileWriter::Save()
{
  ...
  WriteFloat_N(m_NewBarFile, BAR_VERSION);
	...
	{
cout<< m_Results[i].GetName() <<endl;
cout<< m_Results[i].GetGroupName() <<endl;
cout<< m_Results[i].GetVersion() <<endl;
cout<< m_Results[i].GetNumberParameters() <<endl;
...
cout<<"PRINTING PARAMETERS "<<endl;
		...
		{
cout<<m_Results[i].GetParameter(iParam).Tag <<endl;
cout<<m_Results[i].GetParameter(iParam).Value <<endl;

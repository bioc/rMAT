...
\begin{itemize}
\item[]A. Droit, C. Cheung, and R. Gottardo, ``RMAT–an R/Bioconductor package for analyzing ChIP-chip experiments.'' Bioinformatics (Oxford, England), vol. 26, iss. 5, pp. 678-679, 2010.
\end{itemize}
